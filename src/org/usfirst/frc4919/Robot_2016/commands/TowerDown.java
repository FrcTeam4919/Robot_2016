 ...
 *
 */
public class TowerDown extends PIDCommand {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        super("TowerDown", 1.0, 0.0, 0.0, 0.02);
    ...
    protected double returnPIDInput() {
        ...
        return RobotMap.towerAnalogPotentiometer1.pidGet();
    ...
    protected void usePIDOutput(double output) {
        ...
        RobotMap.towerMiniCim1.pidWrite(output);
