...
public class OI {
    ...
    public OI() {
        ...
        backupTowerDownButton = new JoystickButton(driverJoystick, 3);
        backupTowerDownButton.whileHeld(new BackupTowerDown());
        backupTowerUpButton = new JoystickButton(driverJoystick, 5);
        ...
        towerUpButton = new JoystickButton(driverJoystick, 7);
        towerUpButton.whileHeld(new Towerup(0));
        towerDownButton = new JoystickButton(driverJoystick, 9);
        towerDownButton.whileHeld(new Towerdown(0));
        swapview = new JoystickButton(driverJoystick, 4);
        swapview.whenPressed(new SwapView());
        reversePickUp = new JoystickButton(driverJoystick, 6);
        reversePickUp.whileHeld(new ReversePickup());
        ...
        SmartDashboard.putData("BallFeeder", new BallFeeder());
