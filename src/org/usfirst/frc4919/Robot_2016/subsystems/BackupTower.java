 ...
 *
 */
public class BackupTower extends Subsystem {
    ...
    private final SpeedController backupTowerController = RobotMap.backupTowerBackupTowerController;
    ...
    public void backupTowerUp() {
    	backupTowerController.set(0.8);
    }
    public void backupTowerDown() {
    	backupTowerController.set(-0.4);
    }
